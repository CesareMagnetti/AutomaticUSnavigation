...
if __name__ == "__main__":
    ...
    # test on each environment and collect results
    ...
    plane_mean = np.mean(rewards_plane_distance[:][0])  
    anatomy_mean = np.mean(rewards_anatomy[:][0])
    distance_mean = np.mean(distance_from_goal[:][0])
