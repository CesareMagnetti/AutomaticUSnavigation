...
def gather_options():
    ...
    parser.add_argument('--save_every', type=int, default=10, help="save Qnetworks every n episodes.")
    ...
    parser.add_argument('--save_trajectory_every', type=int, default=100, help="every n episodes save a gif of the agent exploiting its policy.")  
